...
import { PostCategory } from '@/src/lib/api/admin/post/new/api-new-post';
      ...
      <div className="border-t border-slate-100 pt-4 space-y-4">
        ...
        <div className="px-1 space-y-1.5">
          ...
          <textarea
            {...register('excerpt')}
            rows={3}
            placeholder="Несколько слов о посте..."
        ...
        <div className="px-1 space-y-1.5">
          ...
          {pages.length === 0 ? (
            <div className="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-slate-50 border border-slate-200">
              ...
              <span className="text-xs text-slate-400">Страниц нет</span>
            </div>
          ) : (
            <select
