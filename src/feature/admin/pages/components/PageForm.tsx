...
export const PageForm = ({ id }: PageFormProps) => {
  ...
  const { register, control, setValue, handleSubmit, formState: { errors } } = useForm<PageFormValues>({
      ...
      <form className="space-y-8" onSubmit={onSubmit}>
        <div className="bg-white p-6 rounded-xl border border-slate-200 space-y-6 shadow-sm">
          <div className="space-y-2">
            <Label htmlFor="title" className="text-base font-semibold">Заголовок страницы</Label>
            <Input
              id="title"
              value={titleValue}
          ...
          <div className="space-y-2">
            <Label htmlFor="slug" className="text-base font-semibold">URL-адрес (Slug)</Label>
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
          ...
          <div className="flex items-center justify-between p-4 rounded-lg border border-slate-100 bg-slate-50">
            <div className="flex items-start gap-3">
              ...
              <div>
                <Label htmlFor="published" className="text-base font-medium cursor-pointer">Опубликовать</Label>
