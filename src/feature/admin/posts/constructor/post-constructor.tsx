...
import { useCreatePost, useGetPostById, useUpdatePost } from '@/lib/api/admin/post/api-get-posts';
...
interface PostConstructorProps {
  ...
  defaultCategory?: import('@/lib/api/admin/post/api-get-posts').PostCategory;
}
...
export const PostConstructor = ({ id, defaultPageId, defaultCategory }: PostConstructorProps) => {
  ...
  const {
    ...
    handleTitleChange,
    handleSlugChange,
  } = useConstructorLogic(existingPost, defaultPageId, defaultCategory);
